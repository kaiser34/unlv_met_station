...
#        param.append(jobs_yr.loc[days,'special'])#Stores whether the following data requires a special fix into a paramater array 
        param[0]=(jobs_yr.loc[days,'morning'])#Stores whether the following data requires a morning fix into a paramater array
        param[1]=(jobs_yr.loc[days,'evening'])#Stores whether the following data requires a evening fix into a paramater array
        param[2]=(jobs_yr.loc[days,'special'])#Stores whether the following data requires a special fix into a paramater array 
